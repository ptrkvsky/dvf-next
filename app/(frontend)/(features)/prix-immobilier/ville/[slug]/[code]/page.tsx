import { SectionMapEntete } from "@/app/(frontend)/(features)/prix-immobilier/ville/components/sectionMapEntete/SectionMapEntete/SectionMapEntete";
import { getCommunes } from "@/app/(frontend)/(features)/prix-immobilier/ville/services/getCommunes";
