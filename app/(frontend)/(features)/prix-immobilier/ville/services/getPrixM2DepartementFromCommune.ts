import type { PrixM2Departement } from "@/app/(frontend)/(features)/prix-immobilier/ville/types/PrixM2Departement";
import { PrixM2DepartementSchema } from "@/app/(frontend)/(features)/prix-immobilier/ville/types/PrixM2Departement";
