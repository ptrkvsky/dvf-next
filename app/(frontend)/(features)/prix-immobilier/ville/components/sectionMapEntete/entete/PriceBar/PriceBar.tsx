import PositionText from "@/app/(frontend)/(features)/prix-immobilier/ville/components/sectionMapEntete/entete/PositionText/PositionText";
import { getPrixM2CommuneGlobal } from "@/app/(frontend)/(features)/prix-immobilier/ville/services/getPrixM2CommuneGlobal";
import { formatPrice } from "@/app/(frontend)/utils/formatPrice";
