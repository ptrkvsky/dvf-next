import { SectionDepartements } from "@/app/(frontend)/(features)/prix-immobilier/region/components/SectionDepartements/SectionDepartements";
import { getRegionFromCode } from "@/app/(frontend)/(features)/prix-immobilier/region/services/getRegionFromCode";
import { getRegions } from "@/app/(frontend)/(features)/prix-immobilier/region/services/getRegions";
