import { SectionVilles } from "@/app/(frontend)/(features)/prix-immobilier/departement/components/SectionVilles";
import { getDepartements } from "@/app/(frontend)/(features)/prix-immobilier/departement/services/getDepartements";
