...
import { PriceBar } from "@/app/(app)/(features)/prix-immobilier/ville/components/sectionMapEntete/entete/PriceBar/PriceBar";
import { getPrixM2Commune } from "@/app/(app)/(features)/prix-immobilier/ville/services/getPrixM2Commune";
import { getPrixM2DepartementFromCommune } from "@/app/(app)/(features)/prix-immobilier/ville/services/getPrixM2DepartementFromCommune";
