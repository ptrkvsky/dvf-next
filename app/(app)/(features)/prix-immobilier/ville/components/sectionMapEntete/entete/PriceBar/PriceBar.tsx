import PositionText from "@/app/(app)/(features)/prix-immobilier/ville/components/sectionMapEntete/entete/PositionText/PositionText";
import { getPrixM2CommuneGlobal } from "@/app/(app)/(features)/prix-immobilier/ville/services/getPrixM2CommuneGlobal";
import { formatPrice } from "@/app/(app)/utils/formatPrice";
