import type { PrixM2Departement } from '@/app/(app)/(features)/prix-immobilier/ville/types/PrixM2Departement';
import { PrixM2DepartementSchema } from '@/app/(app)/(features)/prix-immobilier/ville/types/PrixM2Departement';
