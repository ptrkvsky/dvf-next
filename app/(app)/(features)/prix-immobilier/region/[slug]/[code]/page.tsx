import { SectionDepartements } from "@/app/(app)/(features)/prix-immobilier/region/components/SectionDepartements/SectionDepartements";
import { getRegionFromCode } from "@/app/(app)/(features)/prix-immobilier/region/services/getRegionFromCode";
import { getRegions } from "@/app/(app)/(features)/prix-immobilier/region/services/getRegions";
